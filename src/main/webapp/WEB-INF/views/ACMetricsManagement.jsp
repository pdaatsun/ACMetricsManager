...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="ACMetricsController as ctrl">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">Access Control Operation Metrics Manager </span></div>
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      <input name="dateInput" type="Transaction Date" ng-model="ctrl.tranDate"/>
                      <input type="hidden" ng-model="ctrl.acMetrics.acmID" />
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="analystID">Analyst ID</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.acMetrics.analystID" id="analystID" class="form-control input-sm" placeholder="Enter Analyst ID" required/>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.acMetrics.SNOWID" id="SNOWID" class="form-control input-sm" placeholder="Enter SNOW ID" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.acMetrics.appID" id="appID" class="form-control input-sm" placeholder="Enter Application ID" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.acMetrics.operationID" id="operationID" class="form-control input-sm" placeholder="Enter Operation ID" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.acMetrics.numOfUsers" id="numOfUsers" class="form-control input-sm" placeholder="Enter Number of Users" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                      ...
                      <div class="row">
                          <div class="form-actions floatRight">
                              <input type="submit"  value="{{!ctrl.acMetrics.acmID ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="acm in ctrl.acMetricsList">
                              ...
                              <td>
                              <button type="button" ng-click="ctrl.edit(acm.acmID)" class="btn btn-success custom-width">Edit</button>  <button type="button" ng-click="ctrl.remove(acm.acmID)" class="btn btn-danger custom-width">Remove</button>
                              </td>
                          </tr>
                      </tbody>
                  </table>
